    ...
    data: {
      ...
      theme: {
        create: {
          ...
          font_family: "Inter",
          logo_url: "/logo-dall.svg",
          favicon_url: "/logo-dall.svg",
      ...
      content: {
        create: {
          ...
          founded_year: 2020,
          about_image_url: "/dall-about.jpg",
      ...
      seo_config: {
        create: {
          ...
          canonical_url: "https://dallengenharia.com.br",
          og_image_url: "/dall-hero.jpg",
